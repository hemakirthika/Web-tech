                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-white text-center bg-dark pb-2">
                        <div class="card-body">
                            ...
                            <a  href="beforecolonisation.php"> <button class="btn btn-warning text-dark">Read More</button></a>
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-white text-center bg-dark pb-2">
                        <div class="card-body">
                            ...
                            <a href="aftercolonistion.php"> <button class="btn btn-warning text-dark">Read More</button></a>
            ...
            <div class="col-12 col-md-12 col-lg-4">
                <div class="card text-center bg-white pb-2">
                    <div class="card-body text-dark">
                        ...
                        <a href="tamilnadu.php"> <button class="btn bg-warning text-dark">Learn more</button></a>
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-center bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <a href="maharashtra.php"><button class="btn bg-warning text-dark">Learn more</button></a>
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-center bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <a href="punjab.php"><button class="btn bg-warning text-dark">Learn more</button></a>
                    ...
                    <div class="col-12 col-md-12 col-lg-4">
                        <div class="card text-center bg-white pb-2">
                            <div class="card-body text-dark">
                                ...
                                <a href="jharkhand.php"><button class="btn bg-warning text-dark">Learn more</button></a>
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-center bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <a href="assam.php"><button class="btn bg-warning text-dark">Learn more</button></a>
                    ...
                    <div class="card text-center bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <p class="lead">Gujarat,with its rich history,cultural diversity, and is a crucial state in India. It offers a unique blend of ancient traditions and  making it a fascinating place to explore. From the spiritual ghats of Varanasi to the architectural splendor of the Taj Mahal, Uttar Pradesh captivates with its diverse experiences and profound heritage
                                 <a href="gujarat.php"></p><button class="btn bg-warning text-dark">Learn more</button></a>
